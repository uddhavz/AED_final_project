...
//            Produce product = lt.getProduce();
    ...
    private void initComponents() {
            ...
            .addGroup(panelSendToDietitianLayout.createSequentialGroup()
                ...
                .addGroup(panelSendToDietitianLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelSendToDietitianLayout.createSequentialGroup()
                        ...
                        .addComponent(dietitianPicker, 0, 325, Short.MAX_VALUE))
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(mainPanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1272, Short.MAX_VALUE))
        );
    ...
    private void btnSendResultsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendResultsActionPerformed
        ...
        if (selectedRow < 0){
            CallDialog callDialog = new CallDialog(mainPanel, "Please select a row to send results", false);
            return;
        }
        ...
        if(request.getStatus().equals("Test finished")){
            ...
            CallDialog callDialog = new CallDialog(mainPanel, "Test sent to Dietitian successfully", true);
        }
        else{
                CallDialog callDialog = new CallDialog(mainPanel, "Request has been previously sent", false);
        }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if (isValidData()) {
            ...
            CallDialog callDialog = new CallDialog(mainPanel, "Test result submitted successfully", true);
            populateTable();
        }
    ...
    private void btnPerformTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPerformTestActionPerformed
        ...
        if (selectedRow < 0){
            CallDialog callDialog = new CallDialog(mainPanel, "Please select a row to perform test", false);
            return;
        }
        ...
        if(request.getStatus().equals("Sent for testing")){
            ...
            CallDialog callDialog = new CallDialog(mainPanel, "This test has been processed before", false);
            panelTestResult.setVisible(false);
            return;
        }
