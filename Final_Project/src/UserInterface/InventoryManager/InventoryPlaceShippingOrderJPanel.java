...
public class InventoryPlaceShippingOrderJPanel extends javax.swing.JPanel {
    ...
    private void btnPlaceOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlaceOrderActionPerformed
        ...
        if (noOfRows == 0) {
            CallDialog calldialog = new CallDialog(mainPanel, "Your cart is empty! Please add produces first", false);
            return;
    ...
    private void btnAddCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCartActionPerformed
        ...
        if (selectedRowIndex < 0){
            CallDialog calldialog = new CallDialog(mainPanel, "Please select a row to add", false);
            return;
        }
        ...
        if (isValidData()) {
            ...
            CallDialog calldialog = new CallDialog(mainPanel, "Produce added to cart successfully", true);
        }
