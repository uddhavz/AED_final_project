...
public class ManageDeliveryPartnerJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnProcess.setBackground(new java.awt.Color(102, 204, 0));
        btnProcess.setFont(new java.awt.Font("Myanmar MN", 1, 14)); // NOI18N
        ...
        btnView.setFont(new java.awt.Font("Myanmar MN", 1, 14)); // NOI18N
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        if (selectedRow < 0) {
            CallDialog calldialog = new CallDialog(mainPanel, "Please select an order first", false);
            return;
        }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        panelProcessOrder.setVisible(false);
        populateTable();
        CallDialog calldialog = new CallDialog(mainPanel, "The order is processed successfully", true);
        DefaultTableModel model = (DefaultTableModel) tblOrders.getModel();
        model.setRowCount(0);
